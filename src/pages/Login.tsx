      ...
      <Card className={`w-full max-w-md border-0 ${
        ...
        <CardHeader className={`text-center space-y-4 sm:space-y-6 pt-6 sm:pt-8 ${
          ...
          <div className="space-y-2">
            ...
            <CardDescription className="text-sm sm:text-base">Sign in to continue your mock test prep</CardDescription>
          </div>
        </CardHeader>
          ...
          <CardContent className="space-y-5 sm:space-y-6 px-6 sm:px-8">
            ...
            <div className="space-y-2.5">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-xs sm:text-sm text-accent hover:underline font-medium">Forgot?</Link>
              </div>
              <Input
                id="password"
                type="password"
